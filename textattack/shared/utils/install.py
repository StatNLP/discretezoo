...
def download_if_needed(folder_name):
  ...
  downloaded_file = tempfile.NamedTemporaryFile(dir=TEXTATTACK_CACHE_DIR,
                                                suffix=".zip",
                                                delete=False)
...
TEXTATTACK_CACHE_DIR = os.environ.get("TA_CACHE_DIR",
                                      os.path.expanduser("~/.cache/textattack"))
