...
class AttackResumeCommand(TextAttackCommand):
  ...
  def register_subcommand(main_parser: ArgumentParser):
    ...
    resume_parser.add_argument(
        ...
        required=True,
        help=
        'Path of checkpoint file to resume attack from. If "latest" (or "{directory path}/latest") is entered,'
    ...
    resume_parser.add_argument(
        ...
        default=None,
        help=
        "The directory to save checkpoint files. If not set, use directory from recovered arguments.",
    )
